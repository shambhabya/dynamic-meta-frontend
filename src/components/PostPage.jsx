...
const ImageGenerator = () => {
  ...
  const handleCreateImage = async () => {
    ...
    const baseUrl =
      "https://dynamic-meta-backend.onrender.com/api/generate-og-image";
  ...
  return (
    <div className="h-screen flex flex-col ">
      ...
      <div className="width-full font-bold text-3xl p-6">
        Meta OG Image Generator
      </div>
      <div className="flex  p-6 bg-gray-200 items-center h-full">
        <div className="w-1/2 p-6 bg-white rounded-xl shadow-md">
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              className="mt-1 block w-full rounded-md border-gray shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
              rows="3"
              maxLength={200}
            ></textarea>
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="mt-1 flex rounded-md shadow-sm">
              <span className="inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-grey-50 text-gray-500 text-sm">
                <Image size={18} />
              </span>
              <input
                type="text"
        ...
        <div className="w-1/2 p-6 flex flex-col items-center justify-center">
          <div className="preview-container">
            <div className={`preview ${background} ${template}`}>
              <div className="content">
                <h3>{truncatedTitle || "Your Title Here"}</h3>
                <p>{truncatedDescription || "Your content will appear here"}</p>
              </div>
              <div className="image">
